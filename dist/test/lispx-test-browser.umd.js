...
{
    return eval_test_vm.make_environment(eval_test_vm.get_user_environment());
}
...
describe("Evaluation & Operation", () => {
    ...
    it("Built-in operators are defined.", () => {
        ...
        for (const name of operators) {
            const op = eval_test_vm.get_user_environment().lookup(eval_test_vm.fsym(name));
    ...
    it("Test vm.operate().", () => {
        ...
        const list_op = eval_test_vm.get_user_environment().lookup(eval_test_vm.fsym("list"));
    ...
    it("The environment to operate in can be specified.", () => {
        ...
        const def_op = eval_test_vm.get_user_environment().lookup(eval_test_vm.fsym("%def"));
        const env = make_child_environment();
...
describe("%DEF", () => {
    ...
    it("%DEF evaluates the expression and matches the definiend.", () => {
        ...
        assert.throws(() => eval_test_vm.get_user_environment().lookup(eval_test_vm.fsym("some-fexpr")),
...
{
    return control_test_vm.get_user_environment().lookup(control_test_vm.fsym(name));
}
...
describe("JavaScript Interface", () => {
    ...
    it("Test to_js_function().", () => {
        ...
        const js_fun = js_test_vm.to_js_function(js_test_vm.get_user_environment().lookup(js_test_vm.fsym("list")));
    ...
    it("Test to_lisp_function().", () => {
        ...
        js_test_vm.get_user_environment().put(js_test_vm.fsym("some-fun"), lisp_fun);
...
;// CONCATENATED MODULE: ./tool/fasl.mjs
function init_fasl(vm)
{
    ...
    vm.doit = (target, ext_env) =>
    {
        ...
        vm.dummy_init(topo_map, ext_map);
        vm.dummy_fini(topo_map, ext_map);
    };
    ...
    vm.dummy_ref = (obj, topo_map, ext_map) =>
    {
        if (topo_map.has(obj))
            return vm.emit_call("toporef", [topo_map.get(obj)]);
        else if (ext_map.has(obj)) {
            const ext = ext_map.get(obj);
            if (ext === "ext-env")
                return "ext_env";
            else
                // xxx symref
                return vm.emit_call("extref", [JSON.stringify(vm.write_to_js_string(ext))]);
        }
        else
            throw obj;
    };

    vm.Cons.prototype.dummy_init = function(topo_map, ext_map)
    {
        return vm.emit_call("dcons");
    };
    vm.Function.prototype.dummy_init = function(topo_map, ext_map)
    {
        return vm.emit_call("dfun");
    };
    vm.Fexpr.prototype.dummy_init = function(topo_map, ext_map)
    {
        return vm.emit_call("dfex");
    };
    vm.Standard_object.prototype.dummy_init = function(topo_map, ext_map)
    {
        return vm.emit_call("dobj", [vm.dummy_ref(vm.class_of(this), topo_map, ext_map)]);
    };
    vm.Standard_class.prototype.dummy_init = function(topo_map, ext_map)
    {
        return vm.emit_call("dcls", [vm.dummy_ref(this.get_superclass(), topo_map, ext_map)]);
    };
    vm.Environment.prototype.dummy_init = function(topo_map, ext_map)
    {
        const parent_ref = (this.parent !== null)
              ? vm.dummy_ref(this.parent, topo_map, ext_map)
              : "null";
        return vm.emit_call("denv", [parent_ref]);
    };

    vm.Cons.prototype.dummy_fini = function(topo_map, ext_map)
    {
        return vm.emit_call("fcons", [vm.emit_call("toporef", [topo_map.get(this)]),
                                      vm.emit(this.car()),
                                      vm.emit(this.cdr())]);
    };
    vm.Function.prototype.dummy_fini = function(topo_map, ext_map)
    {
        return vm.emit_call("dfun");
    };
    vm.Fexpr.prototype.dummy_fini = function(topo_map, ext_map)
    {
        return vm.emit_call("dfex");
    };
    vm.Standard_object.prototype.dummy_fini = function(topo_map, ext_map)
    {
        return vm.emit_call("dobj", [vm.dummy_ref(vm.class_of(this), topo_map, ext_map)]);
    };
    vm.Standard_class.prototype.dummy_fini = function(topo_map, ext_map)
    {
        return vm.emit_call("dcls", [vm.dummy_ref(this.get_superclass(), topo_map, ext_map)]);
    };
    vm.Environment.prototype.dummy_fini = function(topo_map, ext_map)
    {
        const parent_ref = (this.parent !== null)
              ? vm.dummy_ref(this.parent, topo_map, ext_map)
              : "null";
    ...
    vm.dummy_init = (topo_map, ext_map) =>
    {
        topo_map.forEach((pos, obj) => {
            console.log(obj.dummy_init(topo_map, ext_map));
        });
    };
    ...
    {
        topo_map.forEach((pos, obj) => {
            console.log(obj.dummy_fini(topo_map, ext_map));
        });
    };
...
const fasl_test_vm = (0,external_lispx_vm_.make_vm)();
init_fasl(fasl_test_vm);

describe("FASL", () => {

    it("Sets.", () => {

        fasl_test_vm.doit(fasl_test_vm.get_user_environment(), fasl_test_vm.get_system_environment());
