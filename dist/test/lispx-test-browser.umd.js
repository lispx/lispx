...
describe("Lisp Tests", () => {
    ...
    const vm = new external_lispx_vm_.VM();
...
const control_test_vm = new external_lispx_vm_.VM();
...
const seq_test_vm = new external_lispx_vm_.VM();
...
const stream_test_vm = new external_lispx_vm_.VM();
...
const read_test_vm = new external_lispx_vm_.VM();
...
const print_test_vm = new external_lispx_vm_.VM();
...
const js_test_vm = new external_lispx_vm_.VM();
